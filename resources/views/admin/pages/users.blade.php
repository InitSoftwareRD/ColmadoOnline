                            ...
                            <div class="form-row">
                                  ...
                                  <div class="col-md-4 mb-3">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <input type="email" class="form-control" id="correo" placeholder="Correo" aria-describedby="Correo" required>
                                    </div>
                                  </div>
                                ...
                                <div class="form-row">
                                  <div class="col-md-4 mb-3">
                                    ...
                                    <input type="phone" class="form-control" id="celular" placeholder="Celular" required>
                                  </div>
                                  ...
                                  <div class="col-md-4 mb-3">
                                      ...
                                      <input type="text" class="form-control" value="cafeteriaaa123" id="pass" name="pass" placeholder="Contraseña" disabled>   
